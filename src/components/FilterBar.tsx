...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="flex flex-wrap gap-2 mb-6 items-center">
      ...
      <div className="relative" style={{ width: '100%', maxWidth: inputWidth || '320px' }}>
        <input
          type="text"
      ...
      {selects.map(sel => (
        sel.name === 'programa' ? (
          ...
          <div key={sel.name} style={{ minWidth: sel.minWidth || '160px', maxWidth: sel.maxWidth || '220px', display: 'flex', alignItems: 'center', gap: '0px', width: sel.width ? '100%' : undefined }}>
            <ProgramAutocomplete
              value={programOption}
          ...
          <div key={sel.name} style={{ minWidth: sel.minWidth || '140px', maxWidth: sel.maxWidth || '220px', width: sel.width ? '100%' : undefined }}>
            {(() => {
